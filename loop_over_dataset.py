...
dataf = 'training_segment-1005081002024129653_5313_150_5333_150_with_camera_labels.tfrecord' # Sequence 1
# dataf = 'training_segment-10072231702153043603_5725_000_5745_000_with_camera_labels.tfrecord' # Sequence 2
# dataf = 'training_segment-10963653239323173269_1924_000_1944_000_with_camera_labels.tfrecord' # Sequence 3
# dataf= 'training_segment-10072231702153043603_5725_000_5745_000_with_camera_labels.tfrecord'
...
exec_detection = ['perform_tracking', 'show_tracks', 'make_tracking_movie'] 
...
while True:
    try:
        ...
        if (configs_det.use_labels_as_objects==True):
            ...
            if 'detect_objects' in exec_list:
                ...
                if 'perform_tracking' in exec_list:
                    detections = load_object_from_file(results_path+'/'+'Lidar_Detections_Tracking_Final_Project', dataf, 'detections', cnt_frame)
                else:
                    detections = load_object_from_file(results_path+'/'+'Lidar_Detections_Tracking_Final_Project', dataf, 'detections_' + configs_det.arch + '_' + str(configs_det.conf_thresh), cnt_frame)
        ...
        if 'validate_object_labels' in exec_list:
            ...
            valid_label_flags = load_object_from_file(results_path+'/'+'Lidar_Detections_Tracking_Final_Project', dataf, 'valid_labels', cnt_frame)            
        ...
        if 'measure_detection_performance' in exec_list:
            ...
            # load different data for final project vs. mid-term project
            if 'perform_tracking' in exec_list:
                det_performance = load_object_from_file(results_path+'/'+'Lidar_Detections_Tracking_Final_Project', dataf, 'det_performance', cnt_frame)
            else:
                det_performance = load_object_from_file(results_path+'/'+'Lidar_Detections_Tracking_Final_Project', dataf, 'det_performance_' + configs_det.arch + '_' + str(configs_det.conf_thresh), cnt_frame)   
